...
class TIHILinkage @Inject constructor(private val delegateLinkage: PostgresSQLinkage, private val redditClient: RedditClient) : Linkage, ObservationLinkage, ConversationLinkage {
private val logger = KotlinLogging.logger {  }
    ...
    override fun saveCommentMessage(submission_id: String, message: Message, comment: Comment): Int {
        return delegateLinkage.saveCommentMessage(submission_id, message, comment)
    }
